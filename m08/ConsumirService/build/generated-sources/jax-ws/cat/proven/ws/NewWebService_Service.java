 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ws.proven.cat/", wsdlLocation = "http://localhost:8081/Wsprova/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/Wsprova/NewWebService?wsdl");
