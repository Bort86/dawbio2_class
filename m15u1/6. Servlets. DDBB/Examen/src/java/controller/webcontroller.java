...
public class webcontroller extends HttpServlet {
        ...
        if (request.getParameter("action") != null) {
            ...
            switch (action) {
                case "showTable":
                    ...
                    break;
                case "addWebForm":
                    response.sendRedirect("add_web.jsp");
                default:
    ...
    private void showTable(HttpServletResponse response, HttpServletRequest request) throws IOException, ClassNotFoundException, ServletException {
        List<Web> webList = new ArrayList();
        
        webdao = new WebDAO(ruta);
        webList = webdao.findAll();
